...
public class CheckBox extends Question {
    ...
    public int getAnswers() {
        ...
        System.out.println("For this question, there are multiple correct answers. To begin answering the question, " +
                "enter 'y'.");
        ...
        while (goingToContinue.indexOf('y') >= 0 && userAnswers.size() <= possibleAnswers.size()) {
            ...
            System.out.println("For this question, there are multiple answers. To continue, answering the question," +
                    "enter 'y'.");
